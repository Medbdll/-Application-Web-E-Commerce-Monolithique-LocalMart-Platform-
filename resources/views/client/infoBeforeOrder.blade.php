    ...
    <main class="min-h-screen bg-black pt-12 pb-24">
        <div class="max-w-5xl mx-auto px-6">
            ...
            <div class="mb-12">
                ...
                <p class="text-gray-400 mt-2 text-sm uppercase tracking-widest">Verify your coordinates and order details
                    before finalizing.</p>
            </div>
                    ...
                    <div class="bg-card-bg border border-gray-800 p-8 h-full">
                        ...
                        <div class="space-y-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="space-y-2">
                                    <label class="text-xs uppercase tracking-widest text-gray-500 font-bold">Pilot
                                        Name</label>
                                    <p class="w-full bg-black border border-gray-800 px-4 py-3 text-white rounded-sm">
                                        {{ $user->name }}</p>
                                </div>
                                <div class="space-y-2">
                                    <label class="text-xs uppercase tracking-widest text-gray-500 font-bold">Contact
                                        Email</label>
                                    <p class="w-full bg-black border border-gray-800 px-4 py-3 text-white rounded-sm">
                                        {{ $user->email }}</p>
                                </div>
                            ...
                            <div class="space-y-2">
                                <label class="text-xs uppercase tracking-widest text-gray-500 font-bold">Shipping
                                    Address</label>
                                <p class="w-full bg-black border border-gray-800 px-4 py-3 text-white rounded-sm">
                                    {{ $address->address_line1 ?? 'Please add an address in your profile' }}</p>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4">
                                ...
                                <div class="space-y-2">
                                    <label class="text-xs uppercase tracking-widest text-gray-500 font-bold">Zip
                                        Code</label>
                                    <p class="w-full bg-black border border-gray-800 px-4 py-3 text-white rounded-sm">
                            ...
                            @if(!$addressExist || !$address->address_line1 || !$address->city || !$address->postal_code || !$address->phone)
                                <button type="button" disabled
                                    ...
                                    <span class="flex items-center justify-center gap-2">
                                        ...
                                        Cannot Place Order - Missing Information
                                    </span>
                                </button>
                            @else
                                <button type="submit"
                                    class="w-full bg-vortexGreen hover:bg-white text-black font-display font-bold py-4 px-6 rounded-lg transition-all duration-300 hover:shadow-lg hover:scale-105">
                                    <span class="flex items-center justify-center gap-2">
