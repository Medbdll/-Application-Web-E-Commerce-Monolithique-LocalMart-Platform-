...
<head>
    ...
    <title>Order Pending Confirmation</title>
</head>
            ...
            <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px; width:100%; background:#ffffff; border-radius:8px;">
                ...
                <tr>
                    <td style="padding:20px 40px; font-size:15px; line-height:24px; color:#374151;">
                        ...
                        <p style="margin:0 0 16px 0;">
                            Thank you for your order. We’ve sent it to the seller and it is now awaiting confirmation.
                        </p>

                        <p style="margin:0 0 16px 0;">
                            Once the seller accepts your order, we’ll notify you immediately and begin processing.
                        </p>
                ...
                <tr>
                    <td align="left" style="padding:10px 40px 30px 40px;">
                        <a href="{{ $order_link ?? '#' }}"
                           style="background-color:#111827; color:#ffffff; text-decoration:none; padding:12px 22px; font-size:14px; font-weight:600; border-radius:6px; display:inline-block;">
                            View order details
                        </a>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="padding:20px 40px 40px 40px; font-size:12px; line-height:18px; color:#6b7280;">
                        You’ll receive another email once the seller confirms your order.<br><br>
